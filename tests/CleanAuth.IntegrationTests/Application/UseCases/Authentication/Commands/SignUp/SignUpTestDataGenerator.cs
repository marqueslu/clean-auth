namespace CleanAuth.IntegrationTests.Application.UseCases.Authentication.Commands.SignUp;
    ...
    public static IEnumerable<object[]> GetInvalidInputs(int times = 15)
    {
        ...
        for (int index = 0; index < times; index++)
        {
            switch (index % totalInvalidCases)
            {
                ...
                case 3:
                    invalidInputsList.Add(
                        [fixture.GetCommandWithNullName(), "Name should not be null or empty."]
                    );
                    break;
                case 4:
                    invalidInputsList.Add(
