...
public class SignUpCommandHandlerTest(SignUpCommandHandlerTestFixture fixture)
{
    ...
    [Fact]
    public async Task Given_RegisterUser_When_InputNameIsLessThan3CharacterLong_Then_ShouldThrowEntityValidationException()
    {
        var userRepositoryMock = fixture.GetUserRepositoryMock();
        var unitOfWork = fixture.GetUnitOfWorkMock();
        var jwtTokenGeneratorMock = fixture.GetJwtTokenGeneratorMock();
    ...
    [Fact]
    public async Task Given_RegisterUser_When_InputNameIsGreaterThan100CharacterLong_Then_ShouldThrowEntityValidationException()
    {
        var userRepositoryMock = fixture.GetUserRepositoryMock();
        var unitOfWork = fixture.GetUnitOfWorkMock();
        var jwtTokenGeneratorMock = fixture.GetJwtTokenGeneratorMock();
    ...
    {
        unitOfWork.Verify(x => x.CommitAsync(It.IsAny<CancellationToken>()), times);
    }

    private static void AssertUserRepositoryCreate(
        Mock<IUserRepository> userRepositoryMock,
        Times times
    )
    {
        userRepositoryMock.Verify(
            x => x.CreateAsync(It.IsAny<DomainEntity.User>(), It.IsAny<CancellationToken>()),
            times
        );
    }
